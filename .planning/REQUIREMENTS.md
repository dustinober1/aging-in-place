...
- [ ] **MEDS-01**: Caregiver or senior can log a medication administration (drug name, dose, time, who administered)
- [ ] **MEDS-02**: Caregiver or senior can set up a recurring medication schedule with local push notification reminders
...
- [ ] **MEDS-05**: Caregiver receives notification if a scheduled medication is not confirmed within a configurable window

### Care Documentation

- [ ] **CARE-01**: Caregiver can log a care visit with structured fields (meals, mobility, observations, concerns)
- [ ] **CARE-02**: Senior can self-report mood on a simple scale (e.g., 1-5 or emoji)
- [ ] **CARE-03**: Caregiver can log observed mood for the senior during a visit
...
- [ ] **CALR-01**: Caregiver or senior can create appointments (doctor visits, PT, etc.) on a shared calendar
- [ ] **CALR-02**: Shared calendar is visible to all permitted care team members
- [ ] **CALR-03**: Appointment reminders are sent as local notifications to relevant care team members
